...
%% from 1 to nb : kinematic
    ...
    ksi_pelvis_z=ksi_pelvis_y+[cross(pos_LLJ,u_pelvis_z); u_pelvis_z]*drBJZ; % determination of the spatial velocity vector
    ...
    psiz(1:3,1:3)=mrot(ksi_pelvis_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3); %intermediate variable
    ...
    dksi_pelvis_z=dksi_pelvis_y+psiz*[cross(pos_LLJ,u_pelvis_z); u_pelvis_z]*drBJZ+[cross(pos_LLJ,u_pelvis_z); u_pelvis_z]*ddrBJZ; %determination of the spatial acceleration vector
...
%% from nb to 1 : effort
    ...
    Is_lowerArmL(4:6,4:6)=I_lowerArmL+m_lowerArmL*mrot(c_lowerArmL)*transpose(mrot(c_lowerArmL)); % spatial inertia matrix
