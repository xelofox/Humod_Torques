...
%% Définition des variables et des paramètres du module
...
%% boucle
%for k=1:length(q)
for k=round(forceStartIndex/2):round(forceEndIndex/2)
    k % indice motion
    i=2*(k-round(forceStartIndex/2)+1); % indice force
...
%% De 1 à nb : cinématique
    ...
    u_pelvis_z=rot_y(rBJY)*rot_x(rBJX)*[0; 0; 1];

    ksi_pelvis_x=[dpBJX*1e-3; dpBJY*1e-3; dpBJZ*1e-3; 0; 0; 0]+[cross(pos_LLJ,u_pelvis_x); u_pelvis_x]*drBJX;
    ksi_pelvis_y=ksi_pelvis_x+[cross(pos_LLJ,u_pelvis_y); u_pelvis_y]*drBJY;
    ksi_pelvis_z=ksi_pelvis_y+[cross(pos_LLJ,u_pelvis_z); u_pelvis_z]*drBJZ;

    psix(1:3,4:6)=mrot(ksi_pelvis_x(1:3));    psiy(1:3,4:6)=mrot(ksi_pelvis_y(1:3));  psiz(1:3,4:6)=mrot(ksi_pelvis_z(1:3));
    psix(1:3,1:3)=mrot(ksi_pelvis_x(4:6));  psix(4:6,4:6)=psix(1:3,1:3);
    psiy(1:3,1:3)=mrot(ksi_pelvis_y(4:6));  psiy(4:6,4:6)=psiy(1:3,1:3);
    psiz(1:3,1:3)=mrot(ksi_pelvis_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);

    dksi_pelvis_x=[ddpBJX*1e-3; ddpBJY*1e-3; ddpBJZ*1e-3; 0; 0; 0]+psix*[cross(pos_LLJ,u_pelvis_x); u_pelvis_x]*drBJX+[cross(pos_LLJ,u_pelvis_x); u_pelvis_x]*ddrBJX;
    dksi_pelvis_y=dksi_pelvis_x+psiy*[cross(pos_LLJ,u_pelvis_y); u_pelvis_y]*drBJY+[cross(pos_LLJ,u_pelvis_y); u_pelvis_y]*ddrBJY;
    ...
    psix(1:3,4:6)=mrot(ksi_abdomen_x(1:3));      psiz(1:3,4:6)=mrot(ksi_abdomen_z(1:3));
    psix(1:3,1:3)=mrot(ksi_abdomen_x(4:6));  psix(4:6,4:6)=psix(1:3,1:3);
    psiz(1:3,1:3)=mrot(ksi_abdomen_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);

    dksi_abdomen_x=dksi_pelvis_z+psix*[cross(pos_LLJ,u_abdomen_x); u_abdomen_x]*drLLJX+[cross(pos_LLJ,u_abdomen_x); u_abdomen_x]*ddrLLJX;
    ...
    psix(1:3,4:6)=mrot(ksi_thorax_x(1:3));    psiy(1:3,4:6)=mrot(ksi_thorax_y(1:3));  psiz(1:3,4:6)=mrot(ksi_thorax_z(1:3));
    psix(1:3,1:3)=mrot(ksi_thorax_x(4:6));  psix(4:6,4:6)=psix(1:3,1:3);
    psiy(1:3,1:3)=mrot(ksi_thorax_y(4:6));  psiy(4:6,4:6)=psiy(1:3,1:3);
    psiz(1:3,1:3)=mrot(ksi_thorax_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);

    dksi_thorax_x=dksi_abdomen_z+psix*[cross(pos_ULJ,u_thorax_x); u_thorax_x]*drULJX+[cross(pos_ULJ,u_thorax_x); u_thorax_x]*ddrULJX;
    dksi_thorax_y=dksi_thorax_x+psiy*[cross(pos_ULJ,u_thorax_y); u_thorax_y]*drULJY+[cross(pos_ULJ,u_thorax_y); u_thorax_y]*ddrULJY;
    ...
    psix(1:3,4:6)=mrot(ksi_head_x(1:3));    psiy(1:3,4:6)=mrot(ksi_head_y(1:3));  psiz(1:3,4:6)=mrot(ksi_head_z(1:3));
    psix(1:3,1:3)=mrot(ksi_head_x(4:6));  psix(4:6,4:6)=psix(1:3,1:3);
    psiy(1:3,1:3)=mrot(ksi_head_y(4:6));  psiy(4:6,4:6)=psiy(1:3,1:3);
    psiz(1:3,1:3)=mrot(ksi_head_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);

    dksi_head_x=dksi_thorax_z+psix*[cross(pos_LNJ,u_head_x); u_head_x]*drLNJX+[cross(pos_LNJ,u_head_x); u_head_x]*ddrLNJX;
    dksi_head_y=dksi_head_x+psiy*[cross(pos_LNJ,u_head_y); u_head_y]*drLNJY+[cross(pos_LNJ,u_head_y); u_head_y]*ddrLNJY;
    ...
    psix(1:3,4:6)=mrot(ksi_upperArmL_x(1:3));    psiy(1:3,4:6)=mrot(ksi_upperArmL_y(1:3));  psiz(1:3,4:6)=mrot(ksi_upperArmL_z(1:3));
    psix(1:3,1:3)=mrot(ksi_upperArmL_x(4:6));  psix(4:6,4:6)=psix(1:3,1:3);
    psiy(1:3,1:3)=mrot(ksi_upperArmL_y(4:6));  psiy(4:6,4:6)=psiy(1:3,1:3);
    psiz(1:3,1:3)=mrot(ksi_upperArmL_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);

    dksi_upperArmL_x=dksi_thorax_z+psix*[cross(pos_SJL,u_upperArmL_x); u_upperArmL_x]*drSJX_L+[cross(pos_SJL,u_upperArmL_x); u_upperArmL_x]*ddrSJX_L;
    dksi_upperArmL_y=dksi_upperArmL_x+psiy*[cross(pos_SJL,u_upperArmL_y); u_upperArmL_y]*drSJY_L+[cross(pos_SJL,u_upperArmL_y); u_upperArmL_y]*ddrSJY_L;
    ...
    psiz(1:3,4:6)=mrot(ksi_lowerArmL_z(1:3));
    psiz(1:3,1:3)=mrot(ksi_lowerArmL_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);
    ...
    psix(1:3,4:6)=mrot(ksi_upperArmR_x(1:3));    psiy(1:3,4:6)=mrot(ksi_upperArmR_y(1:3));  psiz(1:3,4:6)=mrot(ksi_upperArmR_z(1:3));
    psix(1:3,1:3)=mrot(ksi_upperArmR_x(4:6));  psix(4:6,4:6)=psix(1:3,1:3);
    psiy(1:3,1:3)=mrot(ksi_upperArmR_y(4:6));  psiy(4:6,4:6)=psiy(1:3,1:3);
    psiz(1:3,1:3)=mrot(ksi_upperArmR_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);

    dksi_upperArmR_x=dksi_thorax_z+psix*[cross(pos_SJR,u_upperArmR_x); u_upperArmR_x]*drSJX_R+[cross(pos_SJR,u_upperArmR_x); u_upperArmR_x]*ddrSJX_R;
    dksi_upperArmR_y=dksi_upperArmR_x+psiy*[cross(pos_SJR,u_upperArmR_y); u_upperArmR_y]*drSJY_R+[cross(pos_SJR,u_upperArmR_y); u_upperArmR_y]*ddrSJY_R;
    ...
    psiz(1:3,4:6)=mrot(ksi_lowerArmR_z(1:3));
    psiz(1:3,1:3)=mrot(ksi_lowerArmR_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);
    ...
    psix(1:3,4:6)=mrot(ksi_thighL_x(1:3));    psiy(1:3,4:6)=mrot(ksi_thighL_y(1:3));  psiz(1:3,4:6)=mrot(ksi_thighL_z(1:3));
    psix(1:3,1:3)=mrot(ksi_thighL_x(4:6));  psix(4:6,4:6)=psix(1:3,1:3);
    psiy(1:3,1:3)=mrot(ksi_thighL_y(4:6));  psiy(4:6,4:6)=psiy(1:3,1:3);
    psiz(1:3,1:3)=mrot(ksi_thighL_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);

    dksi_thighL_x=dksi_pelvis_z+psix*[cross(pos_HJL,u_thighL_x); u_thighL_x]*drHJX_L+[cross(pos_HJL,u_thighL_x); u_thighL_x]*ddrHJX_L;
    dksi_thighL_y=dksi_thighL_x+psiy*[cross(pos_HJL,u_thighL_y); u_thighL_y]*drHJY_L+[cross(pos_HJL,u_thighL_y); u_thighL_y]*ddrHJY_L;
    ...
    psiz(1:3,4:6)=mrot(ksi_shankL_z(1:3));
    psiz(1:3,1:3)=mrot(ksi_shankL_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);
    ...
    psix(1:3,4:6)=mrot(ksi_footL_x(1:3));    psiy(1:3,4:6)=mrot(ksi_footL_y(1:3));  psiz(1:3,4:6)=mrot(ksi_footL_z(1:3));
    psix(1:3,1:3)=mrot(ksi_footL_x(4:6));  psix(4:6,4:6)=psix(1:3,1:3);
    psiy(1:3,1:3)=mrot(ksi_footL_y(4:6));  psiy(4:6,4:6)=psiy(1:3,1:3);
    psiz(1:3,1:3)=mrot(ksi_footL_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);

    dksi_footL_x=dksi_shankL_z+psix*[cross(pos_AJL,u_footL_x); u_footL_x]*drAJX_L+[cross(pos_AJL,u_footL_x); u_footL_x]*ddrAJX_L;
    dksi_footL_y=dksi_footL_x+psiy*[cross(pos_AJL,u_footL_y); u_footL_y]*drAJY_L+[cross(pos_AJL,u_footL_y); u_footL_y]*ddrAJY_L;
    ...
    psix(1:3,4:6)=mrot(ksi_thighR_x(1:3));    psiy(1:3,4:6)=mrot(ksi_thighR_y(1:3));  psiz(1:3,4:6)=mrot(ksi_thighR_z(1:3));
    psix(1:3,1:3)=mrot(ksi_thighR_x(4:6));  psix(4:6,4:6)=psix(1:3,1:3);
    psiy(1:3,1:3)=mrot(ksi_thighR_y(4:6));  psiy(4:6,4:6)=psiy(1:3,1:3);
    psiz(1:3,1:3)=mrot(ksi_thighR_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);

    dksi_thighR_x=dksi_pelvis_z+psix*[cross(pos_HJR,u_thighR_x); u_thighR_x]*drHJX_R+[cross(pos_HJR,u_thighR_x); u_thighR_x]*ddrHJX_R;
    dksi_thighR_y=dksi_thighR_x+psiy*[cross(pos_HJR,u_thighR_y); u_thighR_y]*drHJY_R+[cross(pos_HJR,u_thighR_y); u_thighR_y]*ddrHJY_R;
    ...
    psiz(1:3,4:6)=mrot(ksi_shankR_z(1:3));
    psiz(1:3,1:3)=mrot(ksi_shankR_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);
    ...
    psix(1:3,4:6)=mrot(ksi_footR_x(1:3));    psiy(1:3,4:6)=mrot(ksi_footR_y(1:3));  psiz(1:3,4:6)=mrot(ksi_footR_z(1:3));
    psix(1:3,1:3)=mrot(ksi_footR_x(4:6));  psix(4:6,4:6)=psix(1:3,1:3);
    psiy(1:3,1:3)=mrot(ksi_footR_y(4:6));  psiy(4:6,4:6)=psiy(1:3,1:3);
    psiz(1:3,1:3)=mrot(ksi_footR_z(4:6));  psiz(4:6,4:6)=psiz(1:3,1:3);

    dksi_footR_x=dksi_shankR_z+psix*[cross(pos_AJR,u_footR_x); u_footR_x]*drAJX_R+[cross(pos_AJR,u_footR_x); u_footR_x]*ddrAJX_R;
    dksi_footR_y=dksi_footR_x+psiy*[cross(pos_AJR,u_footR_y); u_footR_y]*drAJY_R+[cross(pos_AJR,u_footR_y); u_footR_y]*ddrAJY_R;
    dksi_footR_z=dksi_footR_y+psiz*[cross(pos_AJR,u_footR_z); u_footR_z]*drAJZ_R+[cross(pos_AJR,u_footR_z); u_footR_z]*ddrAJZ_R;
...
%% De nb à 1 : effort
    ...
    Is_lowerArmL(4:6,4:6)=I_lowerArmL+m_lowerArmL*mrot(c_lowerArmL)*transpose(mrot(c_lowerArmL));
    
    facc_lowerArmL_z=Is_lowerArmL*dksi_lowerArmL_z+ksi_cross(ksi_lowerArmL_z)*(Is_lowerArmL*ksi_lowerArmL_z);
   
    fi_lowerArmL_z=facc_lowerArmL_z-[m_lowerArmL*g;cross(c_lowerArmL,m_lowerArmL*g)];
    ...
    Is_upperArmL(4:6,4:6)=I_upperArmL+m_upperArmL*mrot(c_upperArmL)*transpose(mrot(c_upperArmL));
    ...
    Is_lowerArmR(4:6,4:6)=I_lowerArmR+m_lowerArmR*mrot(c_lowerArmR)*transpose(mrot(c_lowerArmR));
    ...
    Is_upperArmR(4:6,4:6)=I_upperArmR+m_upperArmR*mrot(c_upperArmR)*transpose(mrot(c_upperArmR));
    ...
    Is_head(4:6,4:6)=I_head+m_head*mrot(c_head)*transpose(mrot(c_head));
    ...
    Is_thorax(4:6,4:6)=I_thorax+m_thorax*mrot(c_thorax)*transpose(mrot(c_thorax));
    ...
    Is_abdomen(4:6,4:6)=I_abdomen+m_abdomen*mrot(c_abdomen)*transpose(mrot(c_abdomen));
    ...
    Is_shankL(4:6,4:6)=I_shankL+m_shankL*mrot(c_shankL)*transpose(mrot(c_shankL));
    ...
    Is_thighL(4:6,4:6)=I_thighL+m_thighL*mrot(c_thighL)*transpose(mrot(c_thighL));
    ...
    Is_shankR(4:6,4:6)=I_shankR+m_shankR*mrot(c_shankR)*transpose(mrot(c_shankR));
    ...
    Is_thighR(4:6,4:6)=I_thighR+m_thighR*mrot(c_thighR)*transpose(mrot(c_thighR));
    ...
    Is_pelvis(4:6,4:6)=I_pelvis+m_pelvis*mrot(c_pelvis)*transpose(mrot(c_pelvis));
...
%% Récupération des couples
    KJZ_L(k-round(forceStartIndex/2)+1)=transpose([cross(pos_KJL,u_shankL_z); u_shankL_z])*fi_shankL_z;
    KJZ_R(k-round(forceStartIndex/2)+1)=transpose([cross(pos_KJR,u_shankR_z); u_shankR_z])*fi_shankR_z;
    
    HJZ_L(k-round(forceStartIndex/2)+1)=transpose([cross(pos_HJL,u_thighL_z); u_thighL_z])*fi_thighL_z;
    HJZ_R(k-round(forceStartIndex/2)+1)=transpose([cross(pos_HJR,u_thighR_z); u_thighR_z])*fi_thighR_z;
    HJY_L(k-round(forceStartIndex/2)+1)=transpose([cross(pos_HJL,u_thighL_y); u_thighL_y])*fi_thighL_y;
    HJY_R(k-round(forceStartIndex/2)+1)=transpose([cross(pos_HJR,u_thighR_y); u_thighR_y])*fi_thighR_y;
    HJX_L(k-round(forceStartIndex/2)+1)=transpose([cross(pos_HJL,u_thighL_x); u_thighL_x])*fi_thighL_x;
    HJX_R(k-round(forceStartIndex/2)+1)=transpose([cross(pos_HJR,u_thighR_x); u_thighR_x])*fi_thighR_x;
    
    AJZ_L(k-round(forceStartIndex/2)+1)=transpose([cross(pos_AJL,u_footL_z); u_footL_z])*fi_footL_z;
    AJZ_R(k-round(forceStartIndex/2)+1)=transpose([cross(pos_AJR,u_footR_z); u_footR_z])*fi_footR_z;
    AJY_L(k-round(forceStartIndex/2)+1)=transpose([cross(pos_AJL,u_footL_y); u_footL_y])*fi_footL_y;
    AJY_R(k-round(forceStartIndex/2)+1)=transpose([cross(pos_AJR,u_footR_y); u_footR_y])*fi_footR_y;
    AJX_L(k-round(forceStartIndex/2)+1)=transpose([cross(pos_AJL,u_footL_x); u_footL_x])*fi_footL_x;
    AJX_R(k-round(forceStartIndex/2)+1)=transpose([cross(pos_AJR,u_footR_x); u_footR_x])*fi_footR_x;

    TrBJZ(k-round(forceStartIndex/2)+1)=transpose([cross(pos_LLJ,u_pelvis_z); u_pelvis_z])*fi_pelvis_z;
    TrBJY(k-round(forceStartIndex/2)+1)=transpose([cross(pos_LLJ,u_pelvis_y); u_pelvis_y])*fi_pelvis_y;
    TrBJX(k-round(forceStartIndex/2)+1)=transpose([cross(pos_LLJ,u_pelvis_x); u_pelvis_x])*fi_pelvis_x;
    TpBJZ(k-round(forceStartIndex/2)+1)=fi_pelvis_x(3);
    TpBJY(k-round(forceStartIndex/2)+1)=fi_pelvis_x(2);
    TpBJX(k-round(forceStartIndex/2)+1)=fi_pelvis_x(1);
    
    LNJZ(k-round(forceStartIndex/2)+1)=transpose([cross(pos_LNJ,u_head_z); u_head_z])*fi_head_z;
    LNJY(k-round(forceStartIndex/2)+1)=transpose([cross(pos_LNJ,u_head_y); u_head_y])*fi_head_y;
    LNJX(k-round(forceStartIndex/2)+1)=transpose([cross(pos_LNJ,u_head_x); u_head_x])*fi_head_x;
    
    SJZ_L(k-round(forceStartIndex/2)+1)=transpose([cross(pos_SJL,u_upperArmL_z); u_upperArmL_z])*fi_upperArmL_z;
    SJY_L(k-round(forceStartIndex/2)+1)=transpose([cross(pos_SJL,u_upperArmL_y); u_upperArmL_y])*fi_upperArmL_y;
    SJX_L(k-round(forceStartIndex/2)+1)=transpose([cross(pos_SJL,u_upperArmL_x); u_upperArmL_x])*fi_upperArmL_x;
    
    SJZ_R(k-round(forceStartIndex/2)+1)=transpose([cross(pos_SJR,u_upperArmR_z); u_upperArmR_z])*fi_upperArmR_z;
    SJY_R(k-round(forceStartIndex/2)+1)=transpose([cross(pos_SJR,u_upperArmR_y); u_upperArmR_y])*fi_upperArmR_y;
    SJX_R(k-round(forceStartIndex/2)+1)=transpose([cross(pos_SJR,u_upperArmR_x); u_upperArmR_x])*fi_upperArmR_x;
    
    EJZ_L(k-round(forceStartIndex/2)+1)=transpose([cross(pos_EJL,u_lowerArmL_z); u_lowerArmL_z])*fi_lowerArmL_z;
    EJZ_R(k-round(forceStartIndex/2)+1)=transpose([cross(pos_EJR,u_lowerArmR_z); u_lowerArmR_z])*fi_lowerArmR_z;
    
    ULJZ(k-round(forceStartIndex/2)+1)=transpose([cross(pos_ULJ,u_thorax_z); u_thorax_z])*fi_thorax_z;
    ULJY(k-round(forceStartIndex/2)+1)=transpose([cross(pos_ULJ,u_thorax_y); u_thorax_y])*fi_thorax_y;
    ULJX(k-round(forceStartIndex/2)+1)=transpose([cross(pos_ULJ,u_thorax_x); u_thorax_x])*fi_thorax_x;
    
    LLJZ(k-round(forceStartIndex/2)+1)=transpose([cross(pos_LLJ,u_abdomen_z); u_abdomen_z])*fi_abdomen_z;
    LLJX(k-round(forceStartIndex/2)+1)=transpose([cross(pos_LLJ,u_abdomen_x); u_abdomen_x])*fi_abdomen_x;

end

Tau_NE(23:36,:)=[HJX_L; HJY_L; HJZ_L; HJX_R; HJY_R; HJZ_R; KJZ_L; KJZ_R; AJX_L; AJY_L; AJZ_L; AJX_R; AJY_R; AJZ_R];
Tau_NE(1:6,:)=[TpBJX; TpBJY; TpBJZ; TrBJX; TrBJY; TrBJZ];
Tau_NE(7:22,:)=[LNJX; LNJY; LNJZ; SJX_L; SJY_L; SJZ_L; SJX_R; SJY_R; SJZ_R; EJZ_L; EJZ_R; ULJX; ULJY; ULJZ; LLJX; LLJZ];
Torques=Tau_NE;
save (strcat("filtered_torques_",Motion,".mat"), 'Torques');
